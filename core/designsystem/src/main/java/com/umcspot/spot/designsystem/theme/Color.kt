...
/* -----------------------------------------------------------
 * 테마 인지형 그라디언트
 * - 기존 정적 BlueGradient/GrayGradient를 대체 가능
 * - 다크/동적 테마 대응
 * ----------------------------------------------------------- */
...
@Stable
class SpotColors(
    primary: Color,          // 주 브랜드 컬러(진)
    primaryStrong: Color,    // 보조 진한 파랑
    primarySoft: Color,      // 연파랑 1
    primarySoftest: Color,   // 연파랑 2
    secondary: Color,        // 포인트(오렌지/옐로우)
    error: Color,            // 에러
    gray500: Color,
    gray400: Color,
    gray300: Color,
    ...
    fun copy() = SpotColors(
        ...
        secondary, error,
        gray500, gray400, gray300, gray200, gray100,
        black, white,
